...
solvers = [
    ...
    odesolvers.AdaptiveResidual(problem, solver='ForwardEuler'),
    ...
    odesolvers.ForwardEuler(problem),
    ...
    odesolvers.RungeKutta3(problem),
    odesolvers.RungeKutta4(problem),
    odesolvers.RungeKuttaFehlberg(problem, rtol=rtol, atol=atol),
