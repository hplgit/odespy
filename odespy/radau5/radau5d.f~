...
C            write(fileout,'(a,a,a,a)') filepath(1:lnblnk(filepath)), 
C     +     namefile(1:lnblnk(namefile)), solver(1:lnblnk(solver)),'.txt' 
...
C            write(fileout,'(a,a,a,a)') filepath(1:lnblnk(filepath)), 
C     +      problm(1:lnblnk(problm)), solver(1:lnblnk(solver)),'.txt' 
